...
#parser.add_argument('--arch',     action="store", dest="arch", default="resnet152",   help="Model Architecture") #
#parser.add_argument('--learning_rate', action="store", dest="learn_rate", type=float, default = 0.001, help="learning rate for optimizer") #
#parser.add_argument('--hidden_units', action="store", dest="node_hidden", type=int, default = 512, help="# Hidden units/nodes")  #
#parser.add_argument('--epochs', action="store", dest="num_epoch",type=int, default = 1, help="Epochs/iteration")   #
...
#print ("hidden units :     " + str(args.node_hidden) )
#print ("epochs :           " + str(args.num_epoch) )
