...
def load_checkpoint(filepath,input_device=device__):
...
def predict(image_path, checkpoint_path, topk=top_num,input_device=device__):
    
    ''' Predict the class (or classes) of an image using a trained deep learning model.
    '''
    
    # TODO: Implement the code to predict the class from an image file
    model_,checkpoint_,input_device= load_checkpoint(checkpoint_path,input_device=device__)
...
title_,class__,flower_name_list_topk,flower_class_list_topk,probability_list_topk,topk_=predict(image_path, checkpoint_path, topk=top_num,input_device=device__)
